...
<table>
  ...
  <tr>
    <td class="table-sentence">
      <p>Run two squares (-1 to Defense per AP spent running, lasting until Reset; may run up to 6 squares per Round at 1AP per 2 squares).</p>
    </td>
    <td>1 per 2 squares</td>
  </tr>
  <tr>
    <td class="table-sentence">
      <p>Rushed attack (Attack with -2 on Attack roll; -1 to Defense until Reset).</p>
    </td>
    <td>1</td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="table-sentence">
      <p>Aimed attack (Attack with +1 on Attack roll; -1 to Defense until Reset.)</p>
    </td>
    <td>3</td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="table-sentence">
      <p>Shield Block (Reflex action, requires shield; double shield Defense Adjustment vs. incoming attack).</p>
    </td>
    <td>1</td>
  </tr>
  <tr>
    <td class="table-sentence">
      <p>Parry (Reflex action, requires ability; completely blocks incoming attack; -2 on all Attack rolls until Reset).</p>
    </td>
    <td>1</td>
  </tr>
  <tr>
    <td class="table-sentence">
      <p>Counterattack (Reflex action, requires ability; attack your attacker <em>before</em> he attacks you; -2 to Attack roll).</p>
    </td>
    <td>1</td>
  </tr>
  <tr>
    <td class="table-sentence">
      <p>Riposte (Response, requires ability; attack your attacker <em>after</em> he attacks you; -1 to Attack roll per HP of damage received).</p>
    </td>
    <td>1</td>
  </tr>
  <tr>
