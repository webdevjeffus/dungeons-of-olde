...
<ul class="bulleted ftrm">
  ...
  <li>Once per Turn, a character may take <strong><span id="free-steps">Free Steps</span></strong> <em>before</em> performing any other <a href="#movements-table">Movement</a> or <a href="#actions-table">Action</a>.
    <ul class="bulleted circle">
  ...
  <li>The Action Phase ends when every character in the combat has either:
    <ul class="bulleted circle">
