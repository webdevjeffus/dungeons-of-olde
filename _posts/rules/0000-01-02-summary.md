...
<p>Sometimes, an <span id="adjustment"><strong>Adjustment</strong></span> will be made to a die roll. In such cases, the number to be added to or subtracted from the roll will be included in the die declaration immediately following the number of sides. As such, <strong>2d4+1</strong> directs you to roll two 4-sided dice, and add 1 to the total, while <strong>1d12!-1</strong> declares that you roll one exploding 12-sided die, and subtract 1 from the result.</p>
...
<p>Any task where there is a chance of meaningful failure is resolved as a <strong>Challenge</strong>. The difficulty of the Challenge is expressed by its descriptive Rank, and a number, called the <strong>Challenge Rating</strong>.</p>
...
<h5 id="check-roll">Check Rolls</h5>
...
<p>Certain skills, items or other circumstances may adjust the result of a Check Roll. <strong>Adjustments</strong> may add to or subtract from the result of the Check roll, and are applied once only, after all exploding dice have been resolved.</p>
<p>Note that <strong>Modifications</strong> change the <em>Die Rank</em> of the dice to be rolled, and are applied <em>before</em> the dice are thrown. Adjustments, on the other hand, change the <em>result</em> of the roll, and are applied <em>after</em> the dice are thrown and totalled.</p>
