...
<h5>Advantage and Disadvantage</h5>
<p>Some die rolls are made with <strong>Advantage</strong> or <strong>Disadvantage</strong>. When rolling with Advantage, roll two dice and use the more favorable result. For Disadvantage, roll two dice and use the less favorable result. For rolls involving multiple dice, roll two full sets of dice, total each set separately, and use the more or less favorable result, as appropriate.</p>
...
<h6 class="ftrm-none">Checks Against Scaling Challenges</h6>
<p>A <strong>Scaling Challenge</strong> occurs in circumstances where the character's doing especially well at the Challenge may result in a quantifiably greater effect. A Scaling Check has a Challenge Rating, but for every Challenge Raging Rank by which the character succeeds, he achieves additional success. For example, if a hero had just a few seconds to gather usable arrows after a battle, the GM might decide to handle the attempt as an Easy Scalable Challenge (CR 6), with each Rank of success turning up three intact arrows. The player rolls his Savvy Check, scoring an 11, and recovers six arrows in all&mdash;three for the succeeding at the Easy level, and three more for also having met the Moderate Challenge Rating of 9.</p>
...
<ol>
  ...
  <li>Roll to recover from any <em>Persistent</em> Conditions</li>
  <li>Regain 1 Mana Point <em>or</em> 1 Faith Point, player's choice</li>
  <li>
...
<table class="table-text-left">
  ...
  <tr>
    <td class="table-sentence"><strong><em>Take a Breather</em></strong> &mdash; Regain 2 Mana or Faith Points</td>
    <td>3/Only</td>
  </tr>
  <tr>
...
<p>After the initial application of First Aid, and barring magical intervention, time and rest are the best source of healing. Once every 24 hours, an injured character makes a Brawn or Nerve Check in a Scaling Challenge, with each rank of success restoring one Hit Point. The Challenge Rating for the Check varies according to the hero's circumstances:
...
<p>A competent caregiver can improve the rate of recovery by increasing the Die Rank the patient rolls in the healing Check. This is handled as an Assisted Attempt, with the caregiver making a Savvy Check against a Scaling Challenge to Assist the patient's healing Check. The Challenge Rating of the Check to Assist is based on the caregiver's level of training as a healer. Each rank of success in the caregiver's Check to Assist improves the Die Rank in the patient's Healing Check by 1.</p>
...
<table>
  ...
  <tr>
    <td class="table-sentence">Trained professional &mdash; a doctor, or the cultural equivalent</td>
    <td>Easy (6)</td>
  </tr>
  <tr>
    <td class="table-sentence">Some training or experience &mdash; a nurse, field medic, or midwife</td>
    <td>Moderate (9)</td>
  </tr>
  <tr>
    <td class="table-sentence">No training or experience &mdash; a sympathetic amateur</td>
    <td>Hard (12)</td>
  </tr>
</table>
