...
<ol>
  ...
  <li>The defender makes a <a href="#opposed-attempts">Defense Check</a> to avoid being hit
  ...
  <li>If the attack hits, damage is resolved by rolling <a href="#effect-rolls">Effect dice</a>.
    <ol class="lower-alpha">
